...
struct BasePotentialCart3D{
    ...
    int nBonds, nAngles, nInterx; //number of bonds and angles, intersections
    col_vector<int> bonds; //list of bonds
    col_vector<int> angles; //list of angles
    col_vector<int> interx; //list of intersections
    col_vector<int> fixed; //list of fixed atoms
    ...
    //constructors
    BasePotentialCart3D();
    BasePotentialCart3D(vector<int> &bondsIn, vector<int> &anglesIn, vector<int> &fixedIn, vector<int> &interxIn, vector<int> &constrainedIn);
...
struct HC3S: public BasePotentialCart3D{
    ...
    //constructors
    HC3S();
    HC3S(vector<int> &bondsIn, vector<int> &anglesIn, vector<int> &fixedIn, vector<int> &interxIn, vector<int> constrIn,
